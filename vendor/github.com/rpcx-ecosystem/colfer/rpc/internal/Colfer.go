...
func (o *Header) Unmarshal(data []byte) (int, error) {
	...
	if header == 2 {
		...
		if x > uint(ColferSizeMax) {
			return 0, ColferMax(fmt.Sprintf("colfer: internal.header.header size %d exceeds %d bytes", x, ColferSizeMax))
		}
