...
import (
	...
	"github.com/rpcx-ecosystem/colfer/rpc/internal"
...
func (c *codec) ReadRequestHeader(ctx context.Context, r *core.Request) error {
	...
	r.Header = c.header.Header
	return nil
}

func (c *codec) ReadResponseHeader(r *core.Response) error {
	c.header = internal.Header{} // reset
	if err := c.decode(&c.header); err != nil {
		return err
	}
...
func (c *codec) ReadRequestBody(ctx context.Context, body interface{}) error {
	if body == nil {
...
func (c *codec) WriteRequest(ctx context.Context, header *core.Request, body interface{}) error {
	// escapes to heap
	h := &internal.Header{
...
func (c *codec) WriteResponse(ctx context.Context, header *core.Response, body interface{}) error {
	// escapes to heap
	h := &internal.Header{
		Method: header.ServiceMethod,
		SeqID:  header.Seq,
