...
// NewClientCodec returns a new core.ClientCodec using JSON-RPC 2.0 on conn.
...
func (c *clientCodec) WriteRequest(ctx context.Context, r *core.Request, param interface{}) error {
...
func (c *clientCodec) ReadResponseHeader(r *core.Response) error {
	// If return err:
...
func (c Client) Notify(ctx context.Context, serviceMethod string, args interface{}) error {
	req := &core.Request{
		ServiceMethod: serviceMethod,
		Seq:           seqNotify,
	}
	return c.codec.WriteRequest(ctx, req, args)
}
...
func NewClient(conn io.ReadWriteCloser) *Client {
	...
	client := core.NewClientWithCodec(codec)
